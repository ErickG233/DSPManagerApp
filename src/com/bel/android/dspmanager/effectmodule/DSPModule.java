...
public class DSPModule {
    ...
    public static void setParameter(AudioEffect audioEffect, int parameter, short value) {
        try {
            ...
            // For API 21 to 29
            AudioEffect.class.getMethod("setParameter", int.class, short.class).invoke(audioEffect, parameter, value);
    ...
    public static void setParameterEqualizer(AudioEffect audioEffect, int band, short level) {
        try {
            ...
            // For API 21 to 29
            AudioEffect.class.getMethod("setParameter", int[].class, short[].class).invoke(audioEffect, param, value);
